...
const FirstNavbar = () => {
  return (
   <section>
      <section className='bg-black  px-5 lg:px-28 py-2'>
            <div className=' hidden lg:flex  justify-between items-center'>
                    ...
                    <div className='flex gap-2'>
                        ...
                        <Link className='text-white' to={'/'}>sales@valuetechnology.net</Link>
                    </div>
                    {/* phone */}
                    <div className='flex gap-2'>
                        ...
                        <Link className='text-white' to={'/'}>+20 23 33 83 659</Link>
